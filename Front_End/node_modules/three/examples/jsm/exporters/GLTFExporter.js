...
GLTFExporter.Utils = {
	...
	mergeMorphTargetTracks: function ( clip, root ) {
		...
		for ( let i = 0; i < sourceTracks.length; ++ i ) {
			...
			/*edited code */
			const morphTargetNames = Object.keys(sourceTrackNode.morphTargetDictionary);
			const morphTargetName = morphTargetNames[sourceTrackBinding.propertyIndex];
			const targetIndex = sourceTrackNode.morphTargetDictionary[morphTargetName];
			/*edited code */
			...
			if ( targetIndex === undefined ) {
				...
				throw new Error( 'THREE.GLTFExporter: Morph target name not found: ' + sourceTrackBinding.path );
